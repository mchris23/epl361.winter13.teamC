...
public class DatabaseManager extends SQLiteOpenHelper {
	...
	// STATIC DATA 
	 ...
	 addCancer(db, 5, "Καρκίνος του Τραχήλου της Μήτρας ",
	 ...
	 addExamination(db, 3,"ΤΕΣΤ ΠΑΠΑΝΙΚΟΛΑΟΥ και υπερηχογράφημα",
...
//	 του Μαστού
	 addExamination(db,4,
	 "Κλινική εξέταση για διάγνωση του Καρκίνου του Μαστού","", 16, 1,
	 "45-120", 3, "0-100", 2, 2, "-", 1,1);
	 //Καρκίνος του Μαστού
	 addCancer(db, 2,"Καρκίνος του Μαστού",
		...
		if (u == null)
			...
			for (int i = 0; i < exams.length(); i++) {
				try {
					...
					if (deleted == 0)
						if (id == 9)
							instance.addExamination(db, id, name, descr, freq,
									sex, age, smoke, dms, history, alcohol,
									"autoeksetasi_orxewn", gender, isexam);
						else if (id == 23)
							instance.addExamination(db, id, name, descr, freq,
									sex, age, smoke, dms, history, alcohol,
									"diatrofi", gender, isexam);
						else
							instance.addExamination(db, id, name, descr, freq,
									sex, age, smoke, dms, history, alcohol,
									"-", gender, isexam);
