...
public class DatabaseManager extends SQLiteOpenHelper {
	...
	public void addData(SQLiteDatabase db) {
		...
		addExamination(db,  "Eμβόλιο για τον ιό των ανθρωπίνων θηλωμάτων","Eνημερωθείτε για το εμβόλιο και εμβολιαστείτε το συντομότερο.  ", 0, 0, "18-25", 3, "0-100", 2, 2, "-", 1);
		
		
		String[] relatedExamsCancerTraxilou={"ΤΕΣΤ ΠΑΠΑΝΙΚΟΛΑΟΥ"};
		String[] relatedExamsPreventions={"Γνωρίστε το σώμα σας Προστατέψετε τον εαυτό σας ","Eμβολιασμός για τον ιό ανθρωπίνων θηλωμάτων"};
		//Καρκίνος του Τραχήλου της Μήτρας 
		addCancer(db, "Καρκίνος του Τραχήλου της Μήτρας ", "Επηρεάζει τον τράχηλο που συνδέει τη μήτρα με τον κόλπο (δες εικ.) \r\nΔεν είναι κληρονομικός. \r\nΜπορεί να προκληθεί από τον ιό των ανθρωπίνων θηλωμάτων (HPV-Human Papilloma Virus) ο οποίος μεταδίδεται με τη σεξουαλική επαφή. \r\nΟι συστάσεις είναι όπως οι έφηβοι 11 ετών και πάνω, αγόρια κορίτσια, εμβολιαστούν για αποτελεσματική πρόληψη.",relatedExamsCancerTraxilou,relatedExamsPreventions,"-");
			
		
		//Γνωρίστε το σώμα σας Προστατέψετε τον εαυτό σας για όλες τις γυναίκες prevention
		addPrevention(db, "Γνωρίστε το σώμα σας Προστατέψετε τον εαυτό σας ","Αν είστε καπνίστρια ενταχθείτε σε Ομάδα Διακοπής του Καπνίσματος και αποδεσμευθείτε από τον 1ο παράγοντα κινδύνου για όλους τους καρκίνους και τον οποίο μπορείτε να ελέγξετε. \r\nΑν είστε έγκυος ή θηλάζετε σταματήστε το κάπνισμα αμέσως. \r\nΑν μεταφέρετε παιδιά στο αυτοκίνητο ή έχετε παιδιά στο σπίτι μην καπνίζετε στους χώρους αυτούς. \r\nΑν δεν καπνίζετε μην ξεκινήσετε ποτέ. Είστε ήδη ελεύθερη! Αν καπνίζουν άλλοι στο χώρο σας διεκδικήστε το δικαίωμά σας για χώρους ελεύθερους από τον καπνό του τσιγάρου. \r\nΤο παθητικό και το τριτογενές κάπνισμα είναι βλαπτικά και επικίνδυνα ιδιαίτερα για παιδιά.","-");
		
		
		//Γνωρίστε το σώμα σας Προστατέψετε τον εαυτό σας για όλους τους άντρες prevention
		addPrevention(db,"Γνωρίστε το σώμα σας Προστατέψετε τον εαυτό σας ","Αν είστε καπνιστής ενταχθείτε σε Ομάδα Διακοπής του Καπνίσματος και αποδεσμευθείτε από τον 1ο παράγοντα κινδύνου για όλους τους καρκίνους και τον οποίο μπορείτε να ελέγξετε. \r\nΑν μεταφέρετε παιδιά στο αυτοκίνητο ή έχετε παιδιά στο σπίτι μην καπνίζετε στους χώρους αυτούς.Αν δεν καπνίζετε μην ξεκινήσετε ποτέ. Είστε ήδη ελεύθερος! \r\nΑν καπνίζουν άλλοι στο χώρο σας διεκδικήστε το δικαίωμά σας για χώρους ελεύθερους από τον καπνό του τσιγάρου. \r\nΤο παθητικό και το τριτογενές κάπνισμα είναι βλαπτικά και επικίνδυνα ιδιαίτερα για παιδιά.","-");
