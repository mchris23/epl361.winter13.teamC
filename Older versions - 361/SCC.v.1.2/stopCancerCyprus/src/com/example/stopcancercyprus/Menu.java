...
public class Menu extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TabSpec settingsSpec=menuTabHost.newTabSpec("Ρυθμήσεις");
		...
		TabSpec notificationSpec=menuTabHost.newTabSpec("Υπενθύμιση");
		notificationSpec.setIndicator("Υπενθύμιση",getResources().getDrawable(R.drawable.mytab4));
		Intent notificationlIntent=new Intent(this,ActivityNotification.class);
		notificationSpec.setContent(notificationlIntent);
		
		menuTabHost.addTab(generalSpec);
		menuTabHost.addTab(personalSpec);
		menuTabHost.addTab(settingsSpec);
		menuTabHost.addTab(notificationSpec);
