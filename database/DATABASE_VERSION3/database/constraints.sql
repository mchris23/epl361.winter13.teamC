...
IF OBJECT_ID('CH_EXAMINATION_SEX','C') IS NOT NULL
ALTER TABLE dbo.EXAMINATION DROP CONSTRAINT CH_EXAMINATION_SEX
GO
ALTER TABLE dbo.EXAMINATION
ADD CONSTRAINT CH_EXAMINATION_SEX CHECK (examination_sex IN(0,1,2))
GO

IF OBJECT_ID('CH_EXAMINATION_AGERANGE','C') IS NOT NULL
ALTER TABLE dbo.EXAMINATION DROP CONSTRAINT CH_EXAMINATION_AGERANGE
GO
ALTER TABLE dbo.EXAMINATION
ADD CONSTRAINT CH_EXAMINATION_AGERANGE CHECK (examination_AGERANGE LIKE '[0-9][0-9][0-9]-[0-9][0-9][0-9]' )
GO

IF OBJECT_ID('CH_EXAMINATION_WEIGHT_RANGE','C') IS NOT NULL
ALTER TABLE dbo.EXAMINATION DROP CONSTRAINT CH_EXAMINATION_WEIGHT_RANGE
GO
ALTER TABLE dbo.EXAMINATION
ADD CONSTRAINT CH_EXAMINATION_WEIGHT_RANGE CHECK (examination_weight LIKE '[0-9][0-9][0-9]-[0-9][0-9][0-9]' )
GO
IF OBJECT_ID('CH_EXAMINATION_HEIGHT_RANGE','C') IS NOT NULL
ALTER TABLE dbo.EXAMINATION DROP CONSTRAINT CH_EXAMINATION_HEIGHT_RANGE
GO
ALTER TABLE dbo.EXAMINATION
ADD CONSTRAINT CH_EXAMINATION_HEIGHT_RANGE CHECK (examination_height LIKE '[0-9][0-9][0-9]-[0-9][0-9][0-9]' )
GO

IF OBJECT_ID('CH_EXAMINATION_SMOKER','C') IS NOT NULL
ALTER TABLE dbo.EXAMINATION DROP CONSTRAINT CH_EXAMINATION_SMOKER
GO
ALTER TABLE dbo.EXAMINATION
ADD CONSTRAINT CH_EXAMINATION_SMOKER CHECK (examination_smoker IN(0,1,2))
GO